...
class ToolForm(FlaskForm): # add date
    scratching = RadioField("Sctratching", choices=[('1','No'), ('2','Yes Occasional'), ('3','Yes Frequent')], default = '0', validators=[DataRequired()])
